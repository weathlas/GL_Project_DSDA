...
namespace glimac {
    ...
    class TextureMini {
        ...
        public:
            TextureMini(const FilePath &applicationPath) : m_program(applicationPath, "src/shaders/utils/screenQuad.vs.glsl", "src/shaders/utils/screenQuad.fs.glsl", ProgramType::TEXTURE) {
