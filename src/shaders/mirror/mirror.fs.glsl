...
void main() {
    ...
    vec4 baseColor = texture(uBaseTexture, vec2(vUV.x, 1-vUV.y));
    ...
    fFragColor.rgb = baseColor.rgb * baseColor.a * colorAtMirrorView.rgb + colorAtMirrorView.rgb * (1-baseColor.a);
}